<footer class="glass-panel border-t border-primary/10 py-12 mt-12 bg-background/50">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="md:flex md:items-center md:justify-between">
            <div class="flex justify-center space-x-6 md:order-2">
                @if($twitter = \App\Models\Setting::get('social_twitter'))
                    <a href="{{ $twitter }}" class="text-text/40 hover:text-primary">
                ...
                @if($facebook = \App\Models\Setting::get('social_facebook'))
                    <a href="{{ $facebook }}" class="text-text/40 hover:text-primary">
