<x-admin-layout>
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="card p-4 border border-border bg-surface/50">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach($categories as $category)
            <div class="card p-6 border border-border bg-surface hover:border-primary/50 transition-colors group">
                <div class="flex justify-between items-start mb-4">
                    ...
                    <form action="{{ route('admin.categories.destroy', $category) }}" method="POST"
                        ...
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="text-text-muted hover:text-danger transition-colors opacity-0 group-hover:opacity-100">
