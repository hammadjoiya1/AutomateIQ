<x-admin-layout>
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-display font-bold text-text">Create Tool</h1>
    ...
    <div class="card p-6 border border-border">
        <form action="{{ route('admin.tools.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3"
                            class="w-full bg-surface border border-border rounded-lg px-4 py-2 text-text focus:border-primary focus:ring-1 focus:ring-primary"></textarea>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="cost_credits" value=""
                            class="w-full bg-surface border border-border rounded-lg px-4 py-2 text-text focus:border-primary focus:ring-1 focus:ring-primary">
                    ...
                    <div>
                        ...
                        <input type="number" name="daily_budget_credits" value=""
                            class="w-full bg-surface border border-border rounded-lg px-4 py-2 text-text focus:border-primary focus:ring-1 focus:ring-primary">
                    ...
                    <div>
                        ...
                        <input type="text" name="tags" placeholder="script, video, hooks"
                            class="w-full bg-surface border border-border rounded-lg px-4 py-2 text-text focus:border-primary focus:ring-1 focus:ring-primary">
                    ...
                    <div>
                        ...
                        <textarea name="prompt_template" rows="5"
                            class="w-full font-mono text-sm bg-surface border border-border rounded-lg px-4 py-2 text-text focus:border-primary focus:ring-1 focus:ring-primary"
                            placeholder="Use {{input_name}} for variables..."></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end pt-6">
                <button type="submit" class="btn btn-primary px-6 py-2">Create Tool</button>
            </div>
        </form>
    </div>
</x-admin-layout>