            ...
            <div
                ...
                <div class="flex h-16 shrink-0 items-center mt-2 gap-2">
                    <a href="{{ route('home') }}" class="flex items-center gap-2 group">
                        ...
                        <span
                            class="font-display font-bold text-2xl tracking-tight text-gradient-primary group-hover:opacity-80 transition-opacity">AutomateIQ</span>
                    </a>
                </div>
        ...
        <div class="lg:pl-72 flex flex-col w-full min-h-screen">
            ...
            <div
                ...
                <div class="flex-1 text-sm font-medium text-text-muted">
                    Dashboard / <span class="text-text">Overview</span>
                </div>
