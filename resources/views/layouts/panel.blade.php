...
<body data-theme="{{ $activeTheme['slug'] ?? 'dark' }}"
    ...
    <div class="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        <div class="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full blur-[120px] opacity-40"
            style="background: rgba(var(--primary-rgb), 0.08)">
        </div>
        <div class="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full blur-[120px] opacity-40"
    ...
    <div class="min-h-full flex" x-data="{ sidebarOpen: false }">
        ...
        <div x-show="sidebarOpen" class="relative z-50 lg:hidden" role="dialog" aria-modal="true">
            ...
            <div class="fixed inset-0 flex">
                <div x-show="sidebarOpen" x-transition:enter="transition ease-in-out duration-300 transform"
                    ...
                    <div
                        class="flex grow flex-col gap-y-5 glass-panel border-r border-border px-6 pb-4">
        ...
        <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col p-4">
            <div
                class="flex grow flex-col gap-y-5 card h-full rounded-2xl px-6 pb-4 border border-border shadow-2xl">
