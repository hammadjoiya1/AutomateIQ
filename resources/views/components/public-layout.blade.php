...
<body data-theme="{{ $activeTheme['slug'] ?? 'dark' }}"
    ...
    <a href="{{ route('pricing') }}" data-analytics-event="cta_pricing_sticky"
        class="pricing-sticky fixed bottom-6 right-6 z-50 hidden sm:inline-flex items-center gap-2 px-5 py-3 rounded-full bg-primary text-white font-semibold shadow-xl hover:bg-primary/90 transition-all">
        See Pricing
