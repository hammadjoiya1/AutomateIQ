        ...
        <nav class="floating-nav fixed top-0 left-0 right-0 w-full z-50 px-6 py-4 md:px-12 transition-all duration-300">
            <div class="max-w-7xl mx-auto flex justify-between items-center">
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-display font-bold text-lg text-text tracking-tight group-hover:opacity-80 transition-opacity">AutomateIQ</span>
                </div>
                <div class="hidden md:flex items-center gap-8">
                    ...
                    @if (Route::has('login'))
                        <div class="flex items-center gap-4">
                            ...
                            @else
                                <a href="{{ route('login') }}" class="text-sm font-medium text-white/60 hover:text-white transition-colors">Log in</a>
                ...
                <div class="flex items-center md:hidden">
                    <button type="button" @click="open = true" class="text-white p-2 rounded-md hover:bg-white/5 transition">
                ...
                <div x-transition:enter="transition ease-out duration-200"
                    ...
                    <div>
                        ...
                        <div class="mt-8 space-y-4">
                            <a href="{{ route('tools.index') }}" @click="open = false" class="block py-2 text-base font-medium text-white/60 hover:text-white transition">Tools</a>
                            <a href="{{ route('workflows.index') }}" @click="open = false" class="block py-2 text-base font-medium text-white/60 hover:text-white transition">Workflows</a>
                            <a href="{{ route('pricing') }}" @click="open = false" class="block py-2 text-base font-medium text-white/60 hover:text-white transition">Pricing</a>
                            <a href="{{ route('blog.index') }}" @click="open = false" class="block py-2 text-base font-medium text-white/60 hover:text-white transition">Blog</a>
                        </div>
                    </div>
                    <div class="border-t border-white/10 pt-6">
                        ...
                        @if (Route::has('login'))
                            @auth
                                <a href="{{ url('/dashboard') }}" @click="open = false" class="btn-primary-white block text-center py-3 rounded-full font-bold transition">Dashboard</a>
                            @else
                                <a href="{{ route('login') }}" @click="open = false" class="block text-center py-3 text-white/60 hover:text-white font-medium mb-3">Log in</a>
                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" @click="open = false" class="btn-primary-white block text-center py-3 rounded-full font-bold transition">Get Started</a>
                                @endif
                            @endauth
                        @endif
                    </div>
